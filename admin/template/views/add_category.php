...
<div class="content pb-0">
    <h1 class="pb-2 display-4">Добавить новую категорию</h1>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form action="?action=category_engine&action_type=add" method="post" enctype="multipart/form-data" class="form-horizontal">
